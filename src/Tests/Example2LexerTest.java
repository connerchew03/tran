...
public class Example2LexerTest{
	...
	@Test
	public void Example2LexerTest() throws Exception {
		var lexer = new Lexer(
			"class Example2\n"+
			"    number x\n"+
			"    string y\n"+
		...
		Assertions.assertEquals("doSomeWork", tokens.get(24).getValue());
		...
		Assertions.assertEquals("x", tokens.get(29).getValue());
		Assertions.assertEquals(Token.TokenTypes.ASSIGN, tokens.get(30).getType());
		Assertions.assertEquals(Token.TokenTypes.NUMBER, tokens.get(31).getType());
		Assertions.assertEquals("10", tokens.get(31).getValue());
		Assertions.assertEquals(Token.TokenTypes.NEWLINE, tokens.get(32).getType());
		Assertions.assertEquals(Token.TokenTypes.LOOP, tokens.get(33).getType());
		Assertions.assertEquals(Token.TokenTypes.WORD, tokens.get(34).getType());
		Assertions.assertEquals("x", tokens.get(34).getValue());
		Assertions.assertEquals(Token.TokenTypes.DOT, tokens.get(35).getType());
		Assertions.assertEquals(Token.TokenTypes.WORD, tokens.get(36).getType());
		Assertions.assertEquals("times", tokens.get(36).getValue());
		Assertions.assertEquals(Token.TokenTypes.LPAREN, tokens.get(37).getType());
		...
		Assertions.assertEquals(Token.TokenTypes.INDENT, tokens.get(40).getType());
		Assertions.assertEquals(Token.TokenTypes.WORD, tokens.get(41).getType());
		Assertions.assertEquals("console", tokens.get(41).getValue());
		Assertions.assertEquals(Token.TokenTypes.DOT, tokens.get(42).getType());
		Assertions.assertEquals(Token.TokenTypes.WORD, tokens.get(43).getType());
		Assertions.assertEquals("print", tokens.get(43).getValue());
		Assertions.assertEquals(Token.TokenTypes.LPAREN, tokens.get(44).getType());
		Assertions.assertEquals(Token.TokenTypes.QUOTEDSTRING, tokens.get(45).getType());
		Assertions.assertEquals("In The Block", tokens.get(45).getValue());
		Assertions.assertEquals(Token.TokenTypes.RPAREN, tokens.get(46).getType());
		...
		Assertions.assertEquals("console", tokens.get(49).getValue());
		Assertions.assertEquals(Token.TokenTypes.DOT, tokens.get(50).getType());
		Assertions.assertEquals(Token.TokenTypes.WORD, tokens.get(51).getType());
		Assertions.assertEquals("print", tokens.get(51).getValue());
		Assertions.assertEquals(Token.TokenTypes.LPAREN, tokens.get(52).getType());
		Assertions.assertEquals(Token.TokenTypes.QUOTEDSTRING, tokens.get(53).getType());
		Assertions.assertEquals("Out of the block", tokens.get(53).getValue());
		Assertions.assertEquals(Token.TokenTypes.RPAREN, tokens.get(54).getType());
		Assertions.assertEquals(Token.TokenTypes.NEWLINE, tokens.get(55).getType());
